...
## Identity
- Agent Name: Query
- Agent ID: seed-api-research-senior
- Role: senior
- Department ID: api-research
- Bundle Path: agents/api-research/Query
...
## Latest Snapshot
- 2026-04-29T06:17:41.474Z | tasks_done=0 | xp=0 | role=senior

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["research","citation","budget"],"two_pass_required":true,"max_review_rounds":null}
