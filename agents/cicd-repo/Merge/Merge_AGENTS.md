...
## Identity
- Agent Name: Merge
- Agent ID: seed-cicd-repo-junior
- Role: junior
- Department ID: cicd-repo
- Bundle Path: agents/cicd-repo/Merge
...
## Latest Snapshot
- 2026-04-28T15:03:10.558Z | tasks_done=1 | xp=10 | role=junior

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["release","consistency","traceability"],"two_pass_required":true,"max_review_rounds":null}
