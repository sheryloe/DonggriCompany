# Design Master_AGENTS

## Identity
- Agent Name: Design Master
- Agent ID: master-design
- Role: master_agent
- Department ID: design
- Bundle Path: agents/design/Design_Master
...
## Class Path
- Class Path: department-master > design > design.master
...
## Latest Snapshot
- 2026-05-28T08:48:07.629Z | tasks_done=0 | xp=0 | role=master_agent

## Workflow Profile
- Raw: {"role":"primary_author","review_lenses":["ux","readability","a11y"],"two_pass_required":true,"max_review_rounds":2}
