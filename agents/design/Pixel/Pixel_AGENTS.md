...
## Identity
- Agent Name: Pixel
- Agent ID: seed-design-ui-system-senior
- Role: senior
- Department ID: design
- Bundle Path: agents/design/Pixel
...
## Class Path
- Class Path: design > frontend > ui.system
...
## Visual Profile
- Visual Profile Key: agent-visual-18
...
## Latest Snapshot
- 2026-05-02T02:20:03.423Z | tasks_done=0 | xp=0 | role=senior

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["consistency","design-system","a11y"],"two_pass_required":true,"max_review_rounds":null}
