...
## Identity
- Agent Name: Bolt
- Agent ID: seed-dev-backend-senior
- Role: senior
- Department ID: dev
- Bundle Path: agents/dev/Bolt
...
## Class Path
- Class Path: dev > backend > backend.api
...
## Visual Profile
- Visual Profile Key: agent-visual-12
...
## Latest Snapshot
- 2026-05-02T02:20:03.410Z | tasks_done=0 | xp=0 | role=senior
