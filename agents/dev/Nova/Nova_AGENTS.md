...
## Identity
- Agent Name: Nova
- Agent ID: seed-dev-frontend-senior
- Role: senior
- Department ID: dev
- Bundle Path: agents/dev/Nova
...
## Class Path
- Class Path: dev > frontend > frontend.react
...
## Visual Profile
- Visual Profile Key: agent-visual-13
...
## Latest Snapshot
- 2026-05-08T03:46:51.786Z | tasks_done=0 | xp=0 | role=senior
