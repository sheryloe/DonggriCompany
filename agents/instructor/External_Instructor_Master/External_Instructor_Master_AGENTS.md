# External Instructor Master_AGENTS

## Identity
- Agent Name: External Instructor Master
- Agent ID: master-instructor
- Role: master_agent
- Department ID: instructor
- Bundle Path: agents/instructor/External_Instructor_Master
...
## Class Path
- Class Path: department-master > instructor > instructor.opensource
...
## Visual Profile
- Visual Profile Key: agent-visual-33
...
## Latest Snapshot
- 2026-05-23T04:13:35.318Z | tasks_done=0 | xp=0 | role=master_agent

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["source_quality","license","adoption_fit"],"two_pass_required":true,"max_review_rounds":null}
