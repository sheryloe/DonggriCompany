...
## Identity
- Agent Name: Note
- Agent ID: seed-knowledge-docs-junior
- Role: junior
- Department ID: knowledge-docs
- Bundle Path: agents/knowledge-docs/Note
...
## Latest Snapshot
- 2026-04-28T15:03:11.173Z | tasks_done=0 | xp=0 | role=junior

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["documentation","clarity","traceability"],"two_pass_required":true,"max_review_rounds":null}
