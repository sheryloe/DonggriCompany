...
## Identity
- Agent Name: Harbor
- Agent ID: seed-operations-lead
- Role: team_leader
- Department ID: operations
- Bundle Path: agents/operations/Harbor
...
## Class Path
- Class Path: operations > memory-manager > operations.control
...
## Latest Snapshot
- 2026-05-08T03:47:38.654Z | tasks_done=1 | xp=10 | role=team_leader

## Workflow Profile
- Raw: {"role":"primary_author","review_lenses":["operations","monitoring","traceability"],"two_pass_required":true,"max_review_rounds":2}
