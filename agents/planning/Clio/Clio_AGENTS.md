...
- Bundle Path: agents/planning/Clio
...
## Class Path
- Class Path: planning > architect > planning.architecture
...
## Visual Profile
- Visual Profile Key: agent-visual-07
...
## Latest Snapshot
- 2026-05-08T03:46:51.759Z | tasks_done=0 | xp=0 | role=senior
