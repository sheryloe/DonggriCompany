# Planning Master_AGENTS

## Identity
- Agent Name: Planning Master
- Agent ID: master-planning
- Role: master_agent
- Department ID: planning
- Bundle Path: agents/planning/Planning_Master
...
## Class Path
- Class Path: department-master > planning > planning.master
...
## Latest Snapshot
- 2026-07-14T21:37:33.145Z | tasks_done=0 | xp=0 | role=master_agent
