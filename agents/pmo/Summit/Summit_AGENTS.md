...
## Identity
- Agent Name: Summit
- Agent ID: seed-pmo-lead
- Role: team_leader
- Department ID: pmo
- Bundle Path: agents/pmo/Summit
...
## Latest Snapshot
- 2026-04-28T15:03:10.671Z | tasks_done=0 | xp=0 | role=team_leader

## Workflow Profile
- Raw: {"role":"primary_author","review_lenses":["scope","priority","dependency"],"two_pass_required":true,"max_review_rounds":2}
