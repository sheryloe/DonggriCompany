...
## Identity
- Agent Name: Tempo
- Agent ID: seed-pmo-risk-senior
- Role: senior
- Department ID: pmo
- Bundle Path: agents/pmo/Tempo
...
## Class Path
- Class Path: pmo > documenter > pmo.risk-evidence
...
## Latest Snapshot
- 2026-05-08T03:39:25.378Z | tasks_done=2 | xp=20 | role=senior

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["timeline","traceability","risk"],"two_pass_required":true,"max_review_rounds":null}
