# Quality Master_AGENTS

## Identity
- Agent Name: Quality Master
- Agent ID: master-quality
- Role: master_agent
- Department ID: quality
- Bundle Path: agents/quality/Quality_Master
...
## Class Path
- Class Path: department-master > quality > quality.master
...
## Latest Snapshot
- 2026-05-28T08:48:07.638Z | tasks_done=0 | xp=0 | role=master_agent

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["test_coverage","regression","evidence"],"two_pass_required":true,"max_review_rounds":null}
