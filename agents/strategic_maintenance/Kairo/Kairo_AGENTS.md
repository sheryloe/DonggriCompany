...
## Identity
- Agent Name: Kairo
- Agent ID: seed-strategic-maintenance-system-senior
- Role: senior
- Department ID: strategic_maintenance
- Bundle Path: agents/strategic_maintenance/Kairo
...
## Class Path
- Class Path: strategic_maintenance > reviewer > strategic-maintenance.system-review
...
## Visual Profile
- Visual Profile Key: agent-visual-03
...
## Latest Snapshot
- 2026-05-13T04:23:30.503Z | tasks_done=0 | xp=0 | role=senior

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["architecture","reliability","security","maintainability"],"two_pass_required":true,"max_review_rounds":null}
