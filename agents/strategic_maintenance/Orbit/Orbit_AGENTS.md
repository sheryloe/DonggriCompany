...
## Identity
- Agent Name: Orbit
- Agent ID: seed-strategic-maintenance-automation-senior
- Role: senior
- Department ID: strategic_maintenance
- Bundle Path: agents/strategic_maintenance/Orbit
...
## Class Path
- Class Path: strategic_maintenance > documenter > strategic-maintenance.automation
...
## Visual Profile
- Visual Profile Key: agent-visual-04
...
## Latest Snapshot
- 2026-05-13T04:23:30.512Z | tasks_done=0 | xp=0 | role=senior

## Workflow Profile
- Raw: {"role":"reviewer","review_lenses":["automation","documentation","traceability","operations"],"two_pass_required":true,"max_review_rounds":null}
