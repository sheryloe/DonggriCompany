...
const MASTER_AGENTS = [
  ...
  },
  {
    ...
    authority: 7,
    sprite: 31,
    personality: "Single persistent project operations agent for project scopes, runtime, Git, Docker, AgentMemory, and AGY review.",
    skills: ["runtime-ops", "git-safety", "agentmemory", "agy-review", "handoff", "status-log"],
