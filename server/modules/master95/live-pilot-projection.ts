...
import { z } from "zod";
import { resolveDonggriV1CandidateRuntimeRoot } from "./candidate-observation.js";
...
const candidatePilotRuntimeRoot = path.join(
...
export const MASTER95_LIVE_PILOT_JSONL = path.join(candidatePilotRuntimeRoot, "pilot-runs.jsonl");
export const MASTER95_LIVE_PILOT_EVENTS_JSONL = path.join(candidatePilotRuntimeRoot, "pilot-events.jsonl");
