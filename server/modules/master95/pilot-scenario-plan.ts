...
const pilotModulePath =
  "G:/Donggri_DevDrive/worktrees/DonggriCompany-v1-stabilization/server/modules/master95/pilot-certification.ts";
const pilotAllowedPaths = ["G:/Donggri_DevDrive/worktrees/DonggriCompany-v1-stabilization/server/modules/master95/*"];
