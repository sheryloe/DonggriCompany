...
const PACK_DEPARTMENT_PRIORITIES: Record<WorkflowPackKey, string[]> = {
  development: ["dev", "qa", "devsecops", "planning", "design", "operations", "pmo"],
  donggri: ["planning", "dev", "design", "qa", "operations", "pmo"],
  report: ["operations", "planning", "qa", "dev", "pmo"],
  web_research_report: ["operations", "dev", "planning", "qa", "pmo"],
  video_preprod: ["design", "planning", "dev", "qa", "operations", "pmo"],
  novel: ["operations", "design", "planning", "dev", "pmo"],
  roleplay: ["design", "planning", "operations", "dev", "pmo"],
};
