...
export const GOAL_COMMAND_PRESETS: readonly GoalCommandPreset[] = [
  {
    ...
    priority: 4,
    requiredDepartments: ["pmo", "planning", "dev", "design", "qa", "operations"],
  ...
  },
  {
    ...
    taskType: "development",
    priority: 4,
    requiredDepartments: ["pmo", "dev", "qa"],
  ...
  },
  {
    ...
    taskType: "analysis",
    priority: 3,
    requiredDepartments: ["pmo", "dev", "qa", "devsecops"],
    maxParallelWorkstreams: 3,
  ...
  },
  {
    ...
    taskType: "development",
    priority: 5,
    requiredDepartments: ["pmo", "dev", "qa", "operations"],
    maxParallelWorkstreams: 3,
  ...
  },
  {
    ...
    taskType: "design",
    priority: 3,
    requiredDepartments: ["pmo", "planning", "design", "dev", "qa"],
    maxParallelWorkstreams: 3,
  ...
  },
  {
    ...
    taskType: "analysis",
    priority: 3,
    requiredDepartments: ["pmo", "operations"],
  ...
  },
  {
    ...
    taskType: "analysis",
    priority: 5,
    requiredDepartments: ["pmo", "devsecops", "dev", "qa"],
    maxParallelWorkstreams: 2,
  ...
  },
  {
    ...
    taskType: "general",
    priority: 5,
    requiredDepartments: ["pmo", "devsecops", "qa", "operations"],
    maxParallelWorkstreams: 3,
