...
const NAV_ITEMS: NavItem[] = [
  { view: "office", label: "운영실", mark: "OF", icon: Building2 },
...
const MASTER_DEPARTMENTS = [
  ...
  { id: "design", label: "디자인", color: "#d946ef", scope: "UI/UX와 한글 품질" },
  { id: "quality", label: "품질", color: "#f97316", scope: "검토와 테스트" },
  { id: "operations", label: "운영", color: "#0f766e", scope: "프로젝트 scope와 런타임" },
  { id: "instructor", label: "외부강사", color: "#7c3aed", scope: "오픈소스/Skill 추천" },
];
    ...
    <aside className="command-sidebar dongri-sidebar flex h-full w-[236px] flex-col backdrop-blur-xl">
      <div className="command-sidebar-brand">
        <button
          ...
          aria-label="Dongri-grigri 운영실 열기"
        >
      ...
      <div className="mx-3 mb-3 rounded-lg border border-cyan-300/30 bg-cyan-300/10 p-3 text-xs" style={{ color: "var(--th-text-secondary)" }}>
        운영 마스터 1개가 프로젝트 scope를 바꿔 맡고, 각 부서 마스터가 필요한 서브에이전트를 작업마다 생성하고 회수합니다.
      </div>
    </aside>
  );
}
