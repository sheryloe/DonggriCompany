...
vi.mock("../api", () => ({
  ...
  getMemorySearchProfiles: vi.fn().mockResolvedValue([]),
  getProjects: vi.fn().mockResolvedValue({ projects: [], page: 1, page_size: 8, total: 0, total_pages: 0 }),
  getQualityMetricSummary: vi.fn().mockResolvedValue([]),
  ...
  deleteMemorySearchProfile: vi.fn().mockResolvedValue(undefined),
