...
> = {
  ...
  whatsapp: {
    label: "WhatsApp",
    targetHint: "phone_number_id:recipient (e.g. 1234567890:+8210...)",
    transportReady: true,
  },
  discord: { label: "Discord", targetHint: "channel_id", transportReady: true },
  googlechat: {
    label: "Google Chat",
    targetHint: "spaces/AAA... (token, webhook URL, or key|token)",
    transportReady: true,
  },
  ...
  imessage: { label: "iMessage", targetHint: "phone number / email (macOS Messages)", transportReady: true },
};
