        ...
        <div className="space-y-4 overflow-y-auto px-5 py-4 max-h-[calc(90vh-72px)]">
          <div className="rounded-xl border border-emerald-500/25 bg-emerald-500/8 px-3 py-2">
            <div className="text-[11px] text-emerald-200">
              {skillText(t, "learning.installCommand")}
            </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="text-xs text-slate-400">
              {skillText(t, "learning.selectProviders")}
            </div>
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-[11px] text-slate-500">
                        {row.agent
                          ...
                          : skillText(t, "learning.unavailable")}
                      </div>
                    </div>
                    ...
                    <div className="flex shrink-0 flex-col items-end gap-1.5">
                      ...
                      {isAlreadyLearned && (
                        ...
                        >
                          {isUnlearning
                            ? skillText(t, "learning.unlearning")
                            : skillText(t, "learning.unlearn")}
                        </button>
                      )}
                    </div>
                  </div>
